...
void main() {
  group('datas', () {
    test('UNI-01 [RN5] gera chave com zeros à esquerda', () {
      expect(chaveData(DateTime(2026, 3, 5)), '2026-03-05');
    });

    test('UNI-02 [RN3] soma dias atravessando mês e ano', () {
    ...
    test('UNI-03 [RN6] calcula primeiro e último dia do mês', () {
    ...
    test('UNI-04 [RN5] escreve a data por extenso em português', () {
